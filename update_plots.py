...
for data_type in ("cases", "deaths"):
    ...
    for country, color in (
        ...
        if data_type == "deaths":
            ...
            ydata = (
                selected_data_deaths.diff().values[start:]
                / selected_data_deaths.values[start - 1 : -1]
            )
            ...
            ydata = (
                selected_data_confirmed_cases.diff().values[start:]
                / selected_data_confirmed_cases.values[start - 1 : -1]
            )
